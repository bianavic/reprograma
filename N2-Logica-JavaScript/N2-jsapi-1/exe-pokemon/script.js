...
/* data.forEach(pokemon => { 
    ...
    titulo.innerChild = pokemon.name
    card.appendChild(title);
    let description = document.createElement('P');
    description.innerChild = pokemon.description;
    card.appendChild(description);
    let imagem = document.createElement('img');
imagem.setAttribute('src',  pokemon.art_url);
title.appendChild(imagem);
let type = document.createElement('p');
type.innerHtml = 'type: '+pokemon.type[0]+ 'e '+pokemon;}else{
